  ...
  <section class="section contenedor">
    ...
    <form id="registro" class="registro" action="pagar.php" method="post">
          ...
          <li>
            <div class="tabla-precio">
              ...
              <div class="orden">
                ...
                <input type="number" id="pase_dia" size="3" name="boletos[un_dia][cantidad]" min="0" placeholder="0">
          ...
          <li>
            <div class="tabla-precio">
              ...
              <div class="orden">
                ...
                <input type="number" id="pase_completo" size="3" name="boletos[completo][cantidad]" min="0" placeholder="0">
          ...
          <li>
            <div class="tabla-precio">
              ...
              <div class="orden">
                ...
                <input type="number" id="pase_dosdias" size="3" name="boletos[2dias][cantidad]" min="0" placeholder="0">
     ...
     <div id="resumen" class="resumen clearfix">
       ...
       <div class="extras">
         <div class="orden">
           <label for="camisa_evento">Camisa del evento $10 <small>(promoción del 7% dto.)</small></label>
